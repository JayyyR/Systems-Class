...
class GroupOfNumbers {
 ...
 protected:
  ...
  //percdown min method for heap sort select
  void percDownMin(long i, long n);
  
  //method for quickselect
  void quickSelectHelp(long left, long right, long k);
  
  //method for linearSelect
  void linearSelectHelp(long left, long right, long k);
